...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('settings/profile', 'settings.profile')->name('profile.edit');
    Route::get('settings/password', 'settings.password')->name('user-password.edit');
    Route::get('settings/appearance', 'settings.appearance')->name('appearance.edit');
